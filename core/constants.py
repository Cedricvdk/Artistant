# Property name constants used throughout the add-on.
# These are used to avoid typos and ensure consistent naming across modules.

# Export operator scene properties
